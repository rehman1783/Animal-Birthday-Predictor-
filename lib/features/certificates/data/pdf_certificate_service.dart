...
class PdfCertificateService {
            ...
            child: pw.Column(
              ...
              children: [
                ...
                _buildCertificateHeader(
                  ...
                  tagline:
                      'Designed for app auto-population and printing as a breeder record and keepsake.',
                  logoImage: logoImage,
                ),
                ...
                _buildBoxedGrid([
                  ...
                  [
                    _buildGridCell(
                      'Sex',
                      foal.sex == 'colt' ? 'Colt (Male)' : 'Filly (Female)',
                      flex: 4,
                      height: 42,
                    ),
                    _buildGridCell(
                      'Colour / Markings',
                      foal.breed?.isNotEmpty == true
                          ? foal.breed!
                          : 'Recorded Markings',
                      flex: 3,
                      height: 42,
                ...
                _buildBoxedGrid([
                  ...
                  [
                    _buildGridCell(
                      'Dam Registration No.',
                      dam?.microchipNo?.isNotEmpty == true
                          ? dam!.microchipNo!
                          : 'On Registry File',
                      flex: 5,
                      height: 42,
                    ...
                    _buildGridCell(
                      ...
                      foal.studBookAssociation?.isNotEmpty == true
                ...
                _buildBoxedGrid([
                  [
                    ...
                    _buildGridCell(
                      'Recipient Mare (If ET/ICSI)',
                      foal.recipientAnimalId?.isNotEmpty == true
                          ? foal.recipientAnimalId!
                          : 'Direct Broodmare Gestation',
                      flex: 3,
                      height: 42,
                    ),
                    _buildGridCell(
                  ...
                  [
                    _buildGridCell(
                      'Place of Birth',
                      'Registered Stud Facility',
                      flex: 4,
                      height: 42,
                    ),
                    _buildGridCell(
                      'Breeder / Stud',
                      breederName.isNotEmpty
                          ? breederName
                    ...
                    _buildGridCell(
                      'Owner',
                      foal.buyerName?.isNotEmpty == true
                          ? foal.buyerName!
                          : (breederName.isNotEmpty
                                ? breederName
                                : 'Recorded Owner'),
                      ...
                      pw.Expanded(
                        ...
                        child: _buildBoxedGrid([
                          [
                            _buildGridCell(
                              'Microchip No.',
                              foal.foalMicrochipNo?.isNotEmpty == true
  ...
  static Future<Uint8List> generatePuppyCertificate({
    ...
    final notesBuffer = StringBuffer();
    if (puppy.generalNotes?.isNotEmpty == true)
      notesBuffer.write(puppy.generalNotes);
              ...
              children: [
                ...
                _buildBoxedGrid([
                  [
                    ...
                    _buildGridCell(
                      'Date of Birth',
                      _formatDate(puppy.dateOfBirth),
                      flex: 3,
                      height: 42,
                    ),
                    _buildGridCell(
                      'Time of Birth',
                      puppy.timeOfBirth?.isNotEmpty == true
                          ? puppy.timeOfBirth!
                          : 'Recorded',
                      flex: 3,
                      height: 42,
                  ...
                  [
                    ...
                    _buildGridCell(
                      'Birth Weight',
                      puppy.birthWeight?.isNotEmpty == true
                          ? puppy.birthWeight!
                          : 'Recorded at birth',
                      flex: 3,
                      height: 42,
                ...
                _buildBoxedGrid([
                  [
                    ...
                    _buildGridCell(
                      'Sire',
                      puppy.sireName?.isNotEmpty == true
                          ? puppy.sireName!
                          : 'Registered Sire Dog',
                      flex: 5,
                      height: 42,
                ...
                _buildBoxedGrid([
                  [
                    ...
                    _buildGridCell(
                      'Owner',
                      puppy.newOwnerName?.isNotEmpty == true
                          ? puppy.newOwnerName!
                          : (breederName.isNotEmpty
                                ? breederName
                                : 'Recorded Owner'),
                  ...
                  [
                    _buildGridCell(
                      'Place of Birth',
                      'Certified Kennel Facility',
                      flex: 4,
                      height: 42,
                    ),
                    _buildGridCell(
                      'Predicted Whelping Date',
                      _formatDate(puppy.dateOfBirth),
                      flex: 3,
                      height: 42,
                    ),
                      ...
                      pw.Expanded(
                        ...
                        child: _buildBoxedGrid([
                          [
                            _buildGridCell(
                              'Microchip No.',
                              puppy.microchipNo?.isNotEmpty == true
                                  ? puppy.microchipNo!
                                  : 'Pending Microchip',
                              height: 40,
                            ),
              ...
              children: [
                ...
                _buildBoxedGrid([
                  [
                    _buildGridCell(
                      'Kitten Name',
                      kittenName.isNotEmpty ? kittenName : 'Kitten Record',
                      flex: 4,
                      height: 42,
                    ),
                    _buildGridCell(
                    ...
                    _buildGridCell(
                      'Time of Birth',
                      timeOfBirth?.isNotEmpty == true ? timeOfBirth! : 'N/A',
                      flex: 3,
                      height: 42,
                    ),
                  ],
  ...
  static Future<Uint8List> generate45DayScanCertificate({
    ...
    final logoImage = await _loadAbpLogo();
    final photoImage = await _loadPhotoFromUrl(
      carrierMare.photoUrl ?? donorMare?.photoUrl,
    );
    final pdf = pw.Document();
    final certId =
        'ABP-45D-${breedingRecord?.coverOrTransferDate?.year ?? pregnancy.foalingDueDate?.year ?? 2026}-${pregnancy.id.replaceAll("-", "").padRight(6, "0").substring(0, 6).toUpperCase()}';

    final isET =
        breedingRecord?.isEmbryoTransfer == true ||
    ...
    final geneticDam = donorMare != null
        ...
        : (breedingRecord?.damOfEmbryo?.isNotEmpty == true
              ? breedingRecord!.damOfEmbryo!
              : 'Donor Mare');
            ...
            child: pw.Column(
              ...
              children: [
                ...
                _buildBoxedGrid([
                  [
                    _buildGridCell(
                      'Carrier Mare (In-Foal)',
                      carrierMare.name,
                      flex: 5,
                      height: 42,
                    ),
                    _buildGridCell(
                      'Gestation Carrier Role',
                      isET
                          ? 'Recipient Carrier (ET/ICSI)'
                  ...
                  [
                    ...
                    _buildGridCell(
                      'Microchip / Reg No',
                      carrierMare.microchipNo?.isNotEmpty == true
                ...
                _buildBoxedGrid([
                  [
                    _buildGridCell(
                      'Genetic Donor Dam',
                      isET ? geneticDam : carrierMare.name,
                      flex: 5,
                      height: 42,
                    ),
                    _buildGridCell(
                      'Covering Sire (Stallion)',
                      stallion,
                      flex: 5,
                      height: 42,
                    ),
                  ...
                  [
                    ...
                    _buildGridCell(
                      'Cover / Transfer Date',
                      breedingRecord?.coverOrTransferDate != null
                          ? _formatDate(breedingRecord!.coverOrTransferDate)
                          : 'Recorded',
                      flex: 5,
                      height: 42,
                    ),
                ...
                _buildBoxedGrid([
                  [
                    _buildGridCell(
                      '1st Scan (Day 14-16)',
                      'Due ${_formatDate(pregnancy.scan1DueDate)} - ${pregnancy.scan1Confirmed ? "CONFIRMED POSITIVE" : "Recorded"}',
                      flex: 5,
                      height: 42,
                    ),
                    _buildGridCell(
                      '2nd Scan (Day 28-30)',
                      'Due ${_formatDate(pregnancy.scan2DueDate)} - ${pregnancy.scan2Confirmed ? "CONFIRMED HEARTBEAT" : "Recorded"}',
                      flex: 5,
                      height: 42,
                    ),
                  ],
                  [
                    _buildGridCell(
                      ...
                      'Due ${_formatDate(pregnancy.scan3DueDate)} - CONFIRMED POSITIVE (Organogenesis Secured)',
                      flex: 5,
                      height: 42,
                    ),
                    _buildGridCell(
                      'Expected Foaling Due Date',
                      _formatDate(pregnancy.foalingDueDate),
                      flex: 5,
                      height: 42,
                    ),
                  ],
                      ...
                      pw.Expanded(
                        ...
                        child: _buildBoxedGrid([
                          ...
                          [
                            _buildGridCell(
                              'Notes',
                              'Official 45-day equine pregnancy scan certificate for Live Foal Guarantee (LFG) records.',
                              height: 60,
                            ),
                          ],
                        ]),
  ...
  static pw.Widget _buildPhotoBox(
    String label, {
    pw.MemoryImage? photoImage,
    double? height,
  }) {
    final placeholderTag =
        '{{${label.replaceAll(' ', '_').replaceAll('/', '_').toUpperCase()}}}';
    return pw.Container(
      height: height ?? 80.0,
      decoration: pw.BoxDecoration(
        border: pw.Border.all(color: PdfColors.black, width: 0.5),
      ...
      child: photoImage != null
          ? pw.ClipRRect(child: pw.Image(photoImage, fit: pw.BoxFit.cover))
          : pw.Center(
              child: pw.Column(
                mainAxisAlignment: pw.MainAxisAlignment.center,
                children: [
  ...
  static Future<Uint8List> generateFoalingDiaryPdf({
    ...
    final overdueCount = entries
        .where((e) => e.movementStage == MovementStage.overdue)
        .length;
    final barnCount = entries
        .where((e) => e.movementStage == MovementStage.foalingBarn)
        .length;
    final paddockCount = entries
        .where((e) => e.movementStage == MovementStage.closePaddock)
        .length;
    final upcomingCount = entries
        .where((e) => e.movementStage == MovementStage.upcoming)
        .length;
              ...
              child: pw.Row(
                ...
                children: [
                  _buildKpiBox(
                    'OVERDUE (>340d)',
                    '$overdueCount Mares',
                    overdueCount > 0 ? alertRed : PdfColors.grey700,
                  ),
                  _buildKpiBox(
                    'FOALING BARN (<14d)',
                    '$barnCount Mares',
                    barnCount > 0 ? alertAmber : PdfColors.grey700,
                  ),
                  _buildKpiBox(
                    'CLOSE PADDOCK (15-30d)',
                    '$paddockCount Mares',
                    PdfColors.purple800,
                  ),
                  _buildKpiBox(
              ...
              children: [
                ...
                ...entries.map((entry) {
                  ...
                  if (entry.isEmbryoTransfer) {
                    methodDesc =
                        'ET (Recip: ${entry.recipientMareName ?? "Yes"})';
                  }
                  ...
                  } else if (entry.movementStage ==
                      MovementStage.closePaddock) {
  ...
  static Future<void> exportOrPrintPdf(
    Uint8List pdfBytes,
    String fileName,
  ) async {
