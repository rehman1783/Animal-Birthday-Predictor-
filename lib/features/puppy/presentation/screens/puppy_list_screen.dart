...
class _PuppyListCard extends StatelessWidget {
  ...
  const _PuppyListCard({required this.puppy, required this.onTap});
      ...
      child: ListTile(
        ...
        title: Row(
          children: [
            Expanded(
              child: Text(
                puppy.puppyName?.isNotEmpty == true ? puppy.puppyName! : 'Puppy ${birthOrder ?? ""}',
            ...
            Container(
              ...
              child: Text(
                puppy.status?.toUpperCase() ?? 'AVAILABLE',
        ...
        subtitle: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                [
                  if (puppy.sex?.isNotEmpty == true) puppy.sex!.toUpperCase(),
        ...
        trailing: const Icon(Icons.arrow_forward_ios_rounded, color: AppColors.primaryGold, size: 14),
      ),
    );
  }
}
